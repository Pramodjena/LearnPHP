...
// $finiteNo = 56;
// $infiniteNo = 1.8e41155;
// $infiniteNo = 100 / 3;

// var_dump(is_finite($finiteNo));
// var_dump(is_infinite($infiniteNo));

// var_dump(is_numeric($age));

// $num1 = 33.3333333; // make it round integer
// echo intval($num1);
...
// max and min 
// echo min(100, 5, 0, -0, 2.555, -1.555);
// echo max(100, 5, 0, -0, 2.555, -1.555);
...
//Todo : Generate random number in b/w 1 to 6.
// echo rand(1, 6);
